                ...
                {/* Static Links */}
                 <div className="px-2 border-t border-gray-200 dark:border-gray-700/50 pt-2">
                     <Link href="/flashcard" passHref>
                         <Button variant="ghost" className="flex items-center justify-start w-full px-2 py-1.5 text-sm font-medium hover:bg-gray-200 dark:hover:bg-[#31333c] rounded" onClick={handleSubChapterClick}>
