            ...
            {sortedModules.map((module, index) => {
              ...
              return (
                ...
                >
                  ...
                  {status === 'available' && <Play className="h-5 w-5 text-[var(--accent-color)] flex-shrink-0" />}
                  {status === 'locked' && <Lock className="h-5 w-5 text-gray-400 flex-shrink-0" />}
             ...
             {progress === 100 && (
                <Card className="mb-8 bg-gradient-to-r from-yellow-400 to-amber-500 text-yellow-900 shadow-lg">
                    ...
                    <CardContent className="p-8 text-center">
                        ...
                        <p className="text-yellow-800 mb-6">You have successfully finished all modules. Claim your certificate now.</p>
